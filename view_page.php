...
<div class="container my-5 py-5">
    ...
    <table class="table">
        <tbody>
            <tr>
                <td><img src="uploaded_img/<?php echo $fetch_products['image']; ?>" alt="" class="img-thumbnail" width="550px"></td>
                <td>
                    <h5 class="card-title"><?php echo $fetch_products['name']; ?></h5>
                    <p class="card-text"><?php echo $fetch_products['details']; ?></p>
                    <p class="card-text text-success price">₱: <?php echo $fetch_products['price']; ?></p>
                    <form action="" method="POST">
                        <div class="input-group">
                            <input type="number" name="product_quantity" value="1" min="0" class="form-control qty">
