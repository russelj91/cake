  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <form action="" method="POST">
        ...
        <input type="submit" value="Add to Cart" name="add_to_cart" class="btn text-light">
      </form>
    </div>
  </div>
</div>
   ...
   <div class="row">
      <div class="col-12 text-center">
         <a href="shop" class="btn text-light mt-4">Browse More</a>
      </div>
   </div>
</div>
   ...
   <h2 class="text-center my-5 py-5" id="about">About</h2>
    <div class="row">
        ...
        <div class="content">
            ...
            <a href="shop" class="btn text-light my-1">Shop Now</a>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-6 my-5 py-5">
        <div class="content">
            ...
            <a href="contact" class="btn text-light my-1">Contact Us</a>
        </div>
    </div>
</div>
